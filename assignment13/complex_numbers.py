num_a1 = float(input("enter your firs number (a1) : "))
num_b1 = float(input("enter your second number (b1) : "))
num_a2 = float(input("enter your first number (a2) : "))
num_b2 = float(input("enter your second number (b2) : "))
